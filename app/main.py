...
async def webhook(request: Request, x_hub_signature_256: str = Header(None)):
    ...
    prompt = (
        ...
        f"- Do not ask for confirmation, approval, or user input at any point\n"
        f"- Do not wait for secrets, credentials, or environment variables — work with what is available in the repo\n"
        f"- Do not pause or suspend the session for any reason\n"
